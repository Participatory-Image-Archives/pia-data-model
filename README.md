...
|`ontology`| Old (hosted on Salsah) and current (hosted on the DaSCH Service Platform) SGV ontology as well as the PIA Data Model in Schema.org and Linked Art (work in progress)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
